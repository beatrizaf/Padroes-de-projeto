...
public class Instituicao extends Participante {
    ...
    @Override
    public void adicionar(Participante participante) { membros.add(participante); }

    @Override
    public void remover(Participante participante) { membros.remove(participante); }

    @Override
    public Participante getFilho(int index) { return membros.get(index); }
    ...
    @Override
    public String toString() { return "Instituição: " + this.nome; }
